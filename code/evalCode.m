...
param.feature = 'tinyimage'; % or tinyimage, bow-patches, bow-sift (optionally gist)
param.classifier = 'knn'; % 'svm' or 'knn'
param.knn.k = 17; % Number of neighbours for the kNN classifier
param.svm.lambda = 3; % lambda parameter (regularization SVM)
